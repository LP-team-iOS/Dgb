...
@implementation JobTableViewCell2
    ...
    if (VipArray.count != 0) {
        for (int i = 0; i < VipArray.count ; i ++) {
            ...
            [iconImg mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.equalTo(vipView.mas_left).with.offset(50*i);
            ...
            iconLabel.font = [UIFont systemFontOfSize:11];
            [iconLabel mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.equalTo(vipView.mas_left).with.offset(12 + 50*i);
                make.top.equalTo(vipView.mas_top).with.offset(0);
                make.size.equalTo(CGSizeMake(25, 12));
            }];
