...
#define FONT_NAME @"NotoSansHans-DemiLight"

@interface DGBctionSheet ()
...
- (void)initTitle {
    if (_title != nil && ![_title isEqualToString:@""]) {
        ...
        _titleLabel.font = [UIFont fontWithName:FONT_NAME size:TITLE_FONT_SIZE];
...
- (void)initButtons {
    if (_buttonTitleArray.count > 0) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            button.titleLabel.font = [UIFont fontWithName:FONT_NAME size:18];
...
- (void)initCancelButton {
    if (_cancelButtonTitle != nil) {
        ...
        _cancelButton.titleLabel.font = [UIFont fontWithName:FONT_NAME size:18];
...
- (void)setTitleColor:(UIColor *)color fontSize:(CGFloat)size {
    ...
    if (size > 0) {
        _titleLabel.font = [UIFont fontWithName:FONT_NAME size:size];
    }
}
...
- (void)setButtonTitleColor:(UIColor *)color bgColor:(UIColor *)bgcolor fontSize:(CGFloat)size atIndex:(int)index {
    ...
    if (size > 0) {
        button.titleLabel.font = [UIFont fontWithName:FONT_NAME size:size];
    }
}
...
- (void)setCancelButtonTitleColor:(UIColor *)color bgColor:(UIColor *)bgcolor fontSize:(CGFloat)size {
    ...
    if (size > 0) {
        _cancelButton.titleLabel.font = [UIFont fontWithName:FONT_NAME size:size];
    }
}
