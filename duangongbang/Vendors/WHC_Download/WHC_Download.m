...
- (void)start{
    ...
    if(![NSURLConnection canHandleRequest:urlRequest]){
        ...
        if(error == nil){
            ...
            LOG(kWHC_calculateFolderSpaceAvailableFailTxt);
        }
    }
}
