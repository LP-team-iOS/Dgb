...
#warning wt---------
    model.allname = [[message.ext objectForKey:@"DGBMessage"] objectForKey:@"BmobUserName"];
    model.otherimageURL = [[message.ext objectForKey:@"DGBMessage"] objectForKey:@"HeadImgUrl"];
...
//            model.content = [[message.ext objectForKey:@"DGBMessage"] objectForKey:@"Context"];
//            NSLog(@"--%@",didReceiveText);
            model.content = [[message.ext objectForKey:@"DGBMessage"] objectForKey:@"Content"];
//            NSLog(@"%@",[[message.ext objectForKey:@"DGBMessage"] objectForKey:@"Content"]);
        }
            break;
