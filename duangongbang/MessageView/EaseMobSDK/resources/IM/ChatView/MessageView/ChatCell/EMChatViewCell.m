...
//        [_retryButton setImage:[UIImage imageNamed:@"messageSendFail.png"] forState:UIControlStateNormal];
        ...
        _hasRead.font = CustomUIFont(12);
        [_hasRead sizeToFit];
        [_activityView addSubview:_hasRead];
    }
    
    //昵称
    _name_wt = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, self.headImageView.frame.size.width + self.headImageView.frame.origin.x + 30, 15)];
    _name_wt.textColor = [UIColor grayColor];
    _name_wt.font = CustomUIFont(12);
    [self.contentView addSubview:_name_wt];
