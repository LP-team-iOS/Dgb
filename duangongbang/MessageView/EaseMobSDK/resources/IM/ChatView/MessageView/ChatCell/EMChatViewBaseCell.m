...
- (id)initWithMessageModel:(MessageModel *)model reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _headImageView.backgroundColor = RCColor(208, 208, 208);
...
//        _nameLabel.font = CustomUIFont(12);
//        [self.contentView addSubview:_nameLabel];
        
#warning 名称实现-------------------
        
//        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 40, 10)];
////        _nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(originX, CELLPADDING , HEAD_SIZE, HEAD_SIZE)];
