...
//    self.backgroundImageView.image = [[UIImage imageNamed:@"messageToolbarBg"] stretchableImageWithLeftCapWidth:0.5 topCapHeight:10];
    ...
    self.toolbarView.frame = CGRectMake(0, 2, self.frame.size.width, kVerticalPadding * 2 + kInputTextViewMinHeight);
...
//    [self.styleChangeButton setImage:[UIImage imageNamed:@"chatBar_keyboard"] forState:UIControlStateSelected];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"detailBackIcon"] forState:UIControlStateNormal];
    ...
    self.moreButton.frame = CGRectMake(CGRectGetWidth(self.bounds) - kHorizontalPadding - kInputTextViewMinHeight - 8, kVerticalPadding + 3, kInputTextViewMinHeight + 7 , kInputTextViewMinHeight - 9);
...
//    [self.moreButton setImage:[UIImage imageNamed:@"chatBar_keyboard"] forState:UIControlStateSelected];
    ...
    self.moreButton.backgroundColor = [UIColor colorWithRed:2/255.0 green:168/255.0 blue:243/255.0 alpha:1];
    ...
    // 初始化输入框
    self.inputTextView = [[XHMessageTextView  alloc] initWithFrame:CGRectMake(textViewLeftMargin, kVerticalPadding  + 3, width, kInputTextViewMinHeight)];
...
//    _inputTextView.layer.cornerRadius = 6.0f;
    ...
    _inputTextView.tintColor = [UIColor colorWithRed:180/255.0 green:180/255.0 blue:180/255.0 alpha:1];
//    _inputTextView.contentVerticalAlignment = UIControlContentVerticalAlignmentCenter;
    ...
    self.faceButton = [[UIButton alloc] initWithFrame:CGRectMake(textViewLeftMargin , kVerticalPadding + 33, width - 5, 0.5 )];
    ...
    self.faceButton.backgroundColor = [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1];
    allButtonWidth += CGRectGetWidth(self.faceButton.frame) + kHorizontalPadding * 1.5;

    
    
    //录制
    self.recordButton = [[UIButton alloc] initWithFrame:CGRectMake(textViewLeftMargin, kVerticalPadding + 10, width, kInputTextViewMinHeight)];
    self.recordButton.titleLabel.font = CustomUIFont(15);
...
//    UIView * viewline = [[UIView alloc] initWithFrame:CGRectMake(textViewLeftMargin, self.toolbarView.frame.size.height - 8, width, 0.5)];
//    viewline.backgroundColor= [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1];
////    viewline.backgroundColor= [UIColor whiteColor];
//    [self.toolbarView addSubview:viewline];
    
    
//        viewline = [[UIView alloc] initWithFrame:CGRectMake(textViewLeftMargin, _inputTextView.frame.size.height - 1, width, 0.5)];
//        viewline.backgroundColor= [UIColor colorWithRed:153/255.0 green:153/255.0 blue:153/255.0 alpha:1];
//        [self.toolbarView addSubview:viewline];
//    allButtonWidth += CGRectGetMaxX(viewline.frame);
//    textViewLeftMargin += CGRectGetMaxX(viewline.frame);
}
