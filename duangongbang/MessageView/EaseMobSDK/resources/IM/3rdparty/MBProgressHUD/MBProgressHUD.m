...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
        self.labelFont = CustomUIFont(kLabelFontSize);
//        [UIFont boldSystemFontOfSize:kLabelFontSize];
        self.detailsLabelFont = CustomUIFont(kDetailsLabelFontSize);
//        [UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
- (void)setupLabels {
    ...
    label.font = CustomUIFont(13);//self.labelFont;
	label.text = self.labelText;
	[self addSubview:label];
	
	detailsLabel = [[UILabel alloc] initWithFrame:self.bounds];
    detailsLabel.font = CustomUIFont(13);//self.detailsLabelFont;
...
//        [(UIActivityIndicatorView *)indicator setColor:blueAlpha];
...
//        _backgroundTintColor = [UIColor colorWithRed:(83)/255.0 green:(83)/255.0 blue:(83)/255.0 alpha:0.5];
