...
//            [_doneButton setTitleTextAttributes:[NSDictionary dictionary] forState:UIControlStateHighlighted];
        ...
        if(self.showRightItem){
            ...
            [rightButton setImage:[UIImage imageNamed:@"icon_more_highlight_tiezi"] forState:UIControlStateNormal];
            [rightButton addTarget:self action:@selector(showActionSheet) forControlEvents:UIControlEventTouchUpInside];
...
//    NSArray *titleArray = @[@"举报"];
//    NSArray *style = @[YUDangerStyle];
//    
//    __weak typeof(self) weakSelf = self;
//    
//    [self.view.window  showPopWithButtonTitles:titleArray styles:style whenButtonTouchUpInSideCallBack:^(int index  ) {
//        
//        if(index==0){
//            if(weakSelf.reportOnClick){
//                weakSelf.reportOnClick();
//            }
//        }
//        
//    }];
...
//    NSDictionary * dict=[NSDictionary dictionaryWithObject:[UIColor whiteColor] forKey:UITextAttributeTextColor];
    ...
    NSDictionary *textAttributes  = @{
                                      NSFontAttributeName: CustomUIFont(16),
...
//            NSLocalizedString(@"of", @"Used in the context: 'Showing 1 of 3 items'"),
        }
	} else {
//		self.title = nil;
	}
...
#pragma mark - 一闪一闪
    CGFloat animationDuration = 0;//(animated ? 0.35 : 0);
...
//        :[NSString stringWithFormat:@"%@\u2026" , NSLocalizedString(@"Saving", @"Displayed with ellipsis as 'Saving...' when an item is in the process of being saved")]]
...
//    NSLocalizedString(@"Failed", @"Informing the user a process has failed") : NSLocalizedString(@"Saved", @"Informing the user an item has been saved")
    [self hideControlsAfterDelay]; // Continue as normal...
}
